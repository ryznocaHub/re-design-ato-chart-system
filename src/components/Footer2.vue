<template>
  ...
  <div class="modal" id="generic_modal_confirm_with_args">
    ...
    <div class="modal-container">
      <div class="modal-body">
        <div class="content">
          <img class="img-modal" alt="image modal" src="../assets/img/Delete.png" >
      ...
      <div class="modal-footer">
        <section  id="generic_modal_with_args_footer"  class="columns">
          <div  class="modal_footer column col-12"><button class="modal-confirm-btn" @click="modalOkExecuteWithArgs()">OK</button><button class="modal-cancel-btn" @click="genericModalWithArgsClose()">キャンセル</button></div>
        </section>
      </div>
    </div>
  </div>
  <div class="modal" id="generic_alert">
    ...
    <div class="modal-container">
      ...
      <div class="modal-footer">
        <section  id="generic_modal_with_args_footer"  class="columns">
          <div  class="modal_footer column col-12"><button class="modal-confirm-btn" @click="modalOkExecute()">OK</button><button class="modal-cancel-btn" @click="genericModalClose()">キャンセル</button></div>
        </section>
      </div>
    </div>
  </div>
